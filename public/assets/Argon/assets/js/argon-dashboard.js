...
function navbarFixed(el) {
    ...
    const isActive = navbar.getAttribute('navbar-scroll') === 'true';
    
    if (isActive) {
        navbar.classList.remove('position-sticky', 'mt-4', 'left-auto', 'top-1', 'z-index-sticky');
        navbar.setAttribute('navbar-scroll', 'false');
    } else {
        navbar.classList.add('position-sticky', 'mt-4', 'left-auto', 'top-1', 'z-index-sticky');
...
function navbarBlurOnScroll(id) {
  ...
  function blurNavbar() {
    ...
    toggleBreadcrumbColor('dark'); // Tambahkan ini
  }
  ...
  function transparentNavbar() {
    ...
    toggleBreadcrumbColor('white'); // Tambahkan ini
  }
  ...
  function toggleBreadcrumbColor(type) {
    let breadcrumbItems = document.querySelectorAll('.breadcrumb .breadcrumb-item, .nav-breadcrumb , .breadcrumb a');
...
for (var i = 0; i < text_nav_link.length; i++) {
    // Hanya ubah elemen yang TIDAK memiliki class active & bg-primary
    if (
        text_nav_link[i].classList.contains('text-dark') &&
        !text_nav_link[i].classList.contains('active') &&
        !text_nav_link[i].classList.contains('bg-primary')
    ) {
...
for (var i = 0; i < text_nav_link_white.length; i++) {
    ...
    if (
        ...
        !text_nav_link_white[i].classList.contains('active') &&
        !text_nav_link_white[i].classList.contains('bg-primary')
    ) {
