                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <select class="form-control kecamatan_id" id="kecamatan_id"
                                            ...
                                            <div class="col-12 mb-1">
                                                <label for="sekolah_id" class="form-label">Tempat Tujuan</label>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                <input type="text"
                                                    ...
                                                    name="gedung" value="{{ old('gedung') }}"
                                                    placeholder="Gedung Tujuan" aria-label="gedung" required>
                                                @error('gedung')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                <input type="text"
                                                    ...
                                                    placeholder="Lantai Tujuan" aria-label="lantai" required>
                                                @error('lantai')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                <input type="text"
                                                    ...
                                                    placeholder="Ruangan Tujuan" aria-label="ruangan" required>
                                                @error('ruangan')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
    ...
    @push('scripts')
        <script type="text/javascript">
            ...
            $('#kecamatan_id').on('change', function() {
                ...
                const $sekolahDropdown = $('#sekolah_id');

                $sekolahDropdown.prop('disabled', true).empty().append('<option value="">Memuat...</option>');
                ...
                if (kecamatanId) {
                    $.ajax({
                        ...
                        success: function(response) {
                            $sekolahDropdown.empty().append('<option value="">Pilih Sekolah</option>');
                            ...
                            if (response.data.length > 0) {
                                response.data.forEach(function(school) {
                                    $sekolahDropdown.append(
                                        $('<option>', {
                                            value: school.id,
                                            text: school.category + ' ' + school.name
                                        })
                                    );
                                });

                                $sekolahDropdown.prop('disabled', false);
                            } else {
                                $sekolahDropdown.append('<option value="">Tidak ada sekolah</option>');
                            }
                        },
                        error: function() {
                            $sekolahDropdown.empty().append('<option value="">Gagal memuat</option>');
                        }
                    });
                } else {
                    $sekolahDropdown.empty().append('<option value="">Pilih Kecamatan Terlebih Dahulu</option>');
                }
            });
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                if (data && data !== '-') {
                                    ...
                                    return `<div>
                                    <strong>Kecamatan:</strong> ${parts[5]}<br>
