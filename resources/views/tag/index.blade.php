        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body table-responsive pb-2">
                    ...
                    <button type="button" class="btn bg-gradient-success rounded-partner" data-bs-toggle="modal"
                        data-bs-target="#distributeTagModal">
                        <i class="fa-solid fa-share-nodes"></i> Distribution
                    </button>
                    @endif
            ...
            <div class="modal-body py-0">
                <div class="card card-plain">
                    <form id="distributeTagForm" method="POST">
                        @csrf
                        <div class="card-header pb-0 text-left">
                            <h4 class="text-success text-gradient">Distribusi <strong>Tag RFID</strong></h4>
                        </div>
                        <div class="card-body mb-3">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="mt-3">
                                ...
                                <select class="form-select select2-kecamatan" name="kecamatan_id" required>
                                    <option></option>
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <button type="submit" class="btn btn-success rounded-partner m-0">Distribusikan</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.select2-kecamatan').select2({
            dropdownParent: $('#distributeTagModal'),
