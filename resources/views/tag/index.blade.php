            ...
            <div class="card my-4">
                ...
                <div class="card-body table-responsive pb-2">
                    <button type="button" class="btn bg-gradient-primary rounded-partner" data-bs-toggle="modal"
                        ...
                        <i class="fa-solid fa-plus"></i> +Inject RFID
                    </button>
                ...
                <div class="card card-plain">
                    <form id="addTagForm" action="{{ route('tag.store') }}" method="POST">
                        ...
                        <div class="card-body mb-3">
                            ...
                            <input type="number" name="from" class="form-control @error('from') is-invalid @enderror"
                                value="{{ old('from') }}" required placeholder="Masukkan nomor awal RFID" autofocus
                                aria-label="From">
                            @error('from')
                            ...
                            <input type="number" name="until" class="form-control @error('until') is-invalid @enderror"
                                value="{{ old('until') }}" required placeholder="Masukkan nomor akhir RFID"
                                aria-label="Until">
                            @error('until')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
