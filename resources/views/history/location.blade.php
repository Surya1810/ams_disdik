...
@section('navbar')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Location History</li>
        </ol>
        <h6 class="nav-breadcrumb font-weight-bolder text-white mb-0">Location History</h6>
    </nav>
@endsection
            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-body table-responsive pb-2">
                        ...
                        <table id="locationTable" class="table text-sm mt-3">
